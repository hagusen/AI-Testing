...
namespace MaxyGames.Events {
	...
	public class DebugLog : Action {
		...
		public override string GenerateCode(Object obj) {
			string DebugName = CodeGenerator.ParseType(typeof(Debug));
			switch(massageType) {
				case MassageType.Info:
					return DebugName + ".Log(" + CodeGenerator.ParseValue((object)message) + ");";
				case MassageType.Warning:
					return DebugName + ".LogWarning(" + CodeGenerator.ParseValue((object)message) + ");";
				case MassageType.Error:
					return DebugName + ".LogError(" + CodeGenerator.ParseValue((object)message) + ");";
			}
			return null;
		}
