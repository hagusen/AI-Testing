...
namespace MaxyGames.uNode.Nodes {
	...
	public class WhileLoopGroup : GroupNode {
		...
		public override string GenerateCode() {
			string data = condition.GenerateConditionCode(this, CodeGenerator.GenerateFlowCode(nodeToExecute, this));
			if(!string.IsNullOrEmpty(data)) {
				return data.Remove(0, 2).Insert(0, "while") + CodeGenerator.GetFinishCode(this, true, false, false);
			}
			return null;
		}
	}
