...
namespace MaxyGames.Events {
	...
	public class ObjectCompare : Condition {
		...
		public MultipurposeMember targetA;
		[Filter(MaxMethodParam = int.MaxValue)]
		public MultipurposeMember targetB;
		...
		public override string GenerateConditionCode(Object obj) {
			return CodeGenerator.GenerateCompareCode(
				CodeGenerator.ParseValue(targetA), 
				CodeGenerator.ParseValue(targetB), 
				operatorType);
		}
