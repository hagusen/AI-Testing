...
namespace MaxyGames {
	public static class Operator {
		...
		public static object Convert(object value, Type type) {
			...
			try {
				...
				throw new InvalidCastException($"Cannot convert '{value.GetType().FullName}' to {type.FullName}", ex);
			}
	...
	public static class Operators {
		#region Arithmetic
		static System.Func<object, object, bool> equal, notEqual, greaterThan, lessThan, greaterThanOrEqual, lessThanOrEqual;

		static Dictionary<string, System.Func<object, object, object>> _ListAdd;
		public static object Add(object a, object b, Type fType, Type tType) {
			if(a is string || b is string) {
				return string.Concat(a, b);
			}
			if(_ListAdd == null) {
				_ListAdd = new Dictionary<string, System.Func<object, object, object>>();
			}
			if(fType != tType) {
			...
			string tName = fType.FullName + tType.FullName;
			if(!_ListAdd.ContainsKey(tName)) {
				try {
					...
					if(fType.IsPrimitive && tType.IsPrimitive) {
						...
						if(method != null) {
							...
							if(sameParamType) {
								...
								func = (x, y) => {
									return method.InvokeOptimized(null, new[] { Convert(x, paramTypes[0]), Convert(y, paramTypes[0]) });
								};
							}
						} else {
							throw;
		...
		static Dictionary<string, System.Func<object, object, object>> _ListModulo;
		public static object Modulo(object a, object b, Type fType, Type tType) {
			...
			if(_ListModulo == null) {
				_ListModulo = new Dictionary<string, System.Func<object, object, object>>();
			}
			System.Func<object, object, object> func;
			string tName = fType.FullName + tType.FullName;
			if(!_ListModulo.ContainsKey(tName)) {
				try {
					ParameterExpression paramA = Expression.Parameter(typeof(object), "a"),
						paramB = Expression.Parameter(typeof(object), "b");
				...
				_ListModulo.Add(tName, func);
			} else {
				func = _ListModulo[tName];
			}
			return func(a, b);
		}

		static Dictionary<string, System.Func<object, object, object>> _ListSubtract;
		public static object Subtract(object a, object b, Type fType, Type tType) {
			...
			if(_ListSubtract == null) {
				_ListSubtract = new Dictionary<string, System.Func<object, object, object>>();
			}
			System.Func<object, object, object> func;
			string tName = fType.FullName + tType.FullName;
			if(!_ListSubtract.ContainsKey(tName)) {
				try {
					ParameterExpression paramA = Expression.Parameter(typeof(object), "a"),
						paramB = Expression.Parameter(typeof(object), "b");
				...
				_ListSubtract.Add(tName, func);
			} else {
				func = _ListSubtract[tName];
			}
			return func(a, b);
		}

		static Dictionary<string, System.Func<object, object, object>> _ListDivide;
		public static object Divide(object a, object b, Type fType, Type tType) {
			...
			if(_ListDivide == null) {
				_ListDivide = new Dictionary<string, System.Func<object, object, object>>();
			}
			System.Func<object, object, object> func;
			string tName = fType.FullName + tType.FullName;
			if(!_ListDivide.ContainsKey(tName)) {
				try {
					ParameterExpression paramA = Expression.Parameter(typeof(object), "a"),
						paramB = Expression.Parameter(typeof(object), "b");
				...
				_ListDivide.Add(tName, func);
			} else {
				func = _ListDivide[tName];
			}
			return func(a, b);
		}

		static Dictionary<string, System.Func<object, object, object>> _ListMultiply;
		public static object Multiply(object a, object b, Type fType, Type tType) {
			...
			if(_ListMultiply == null) {
				_ListMultiply = new Dictionary<string, System.Func<object, object, object>>();
			}
			System.Func<object, object, object> func;
			string tName = fType.FullName + tType.FullName;
			if(!_ListMultiply.ContainsKey(tName)) {
				try {
					ParameterExpression paramA = Expression.Parameter(typeof(object), "a"),
						paramB = Expression.Parameter(typeof(object), "b");
					func = Expression.Lambda<System.Func<object, object, object>>(
				...
				_ListMultiply.Add(tName, func);
			} else {
				func = _ListMultiply[tName];
			}
			return func(a, b);
		}
		...
		static Dictionary<string, System.Func<object, object, bool>> _listEqual, _listNotEqual, _listGreaterThan, _listLessThan, _listGreaterThanOrEqual, _listLessThanOrEqual;
		...
		public static bool Equal(object a, object b, Type aType, Type bType) {
			...
			if(_listEqual == null) {
				_listEqual = new Dictionary<string, System.Func<object, object, bool>>();
			}
			System.Func<object, object, bool> func;
			string tName = aType.FullName + bType.FullName;
			if(!_listEqual.ContainsKey(tName)) {
				try {
					ParameterExpression paramA = Expression.Parameter(typeof(object), "a"),
						paramB = Expression.Parameter(typeof(object), "b");
				...
				_listEqual.Add(tName, func);
			} else {
				func = _listEqual[tName];
			}
			return func(a, b);
		}
		...
		public static bool NotEqual(object a, object b, Type aType, Type bType) {
			...
			if(_listNotEqual == null) {
				_listNotEqual = new Dictionary<string, System.Func<object, object, bool>>();
			}
			System.Func<object, object, bool> func;
			string tName = aType.FullName + bType.FullName;
			if(!_listNotEqual.ContainsKey(tName)) {
				try {
					ParameterExpression paramA = Expression.Parameter(typeof(object), "a"),
						paramB = Expression.Parameter(typeof(object), "b");
				...
				_listNotEqual.Add(tName, func);
			} else {
				func = _listNotEqual[tName];
			}
			return func(a, b);
		}
		...
		public static bool GreaterThan(object a, object b, Type aType, Type bType) {
			...
			if(_listGreaterThan == null) {
				_listGreaterThan = new Dictionary<string, System.Func<object, object, bool>>();
			}
			System.Func<object, object, bool> func;
			string tName = aType.FullName + bType.FullName;
			if(!_listGreaterThan.ContainsKey(tName)) {
				try {
					ParameterExpression paramA = Expression.Parameter(typeof(object), "a"),
						paramB = Expression.Parameter(typeof(object), "b");
					...
					if(aType.IsPrimitive && bType.IsPrimitive) {
						...
						if(method != null) {
							...
							if(sameParamType) {
								...
								func = (x, y) => {
									return (bool)method.InvokeOptimized(null, new[] { Convert(x, paramTypes[0]), Convert(y, paramTypes[0]) });
								};
							}
						} else {
							throw;
				...
				_listGreaterThan.Add(tName, func);
			} else {
				func = _listGreaterThan[tName];
			}
			return func(a, b);
		}
		...
		public static bool LessThan(object a, object b, Type aType, Type bType) {
			...
			if(_listLessThan == null) {
				_listLessThan = new Dictionary<string, System.Func<object, object, bool>>();
			}
			System.Func<object, object, bool> func;
			string tName = aType.FullName + bType.FullName;
			if(!_listLessThan.ContainsKey(tName)) {
				try {
					ParameterExpression paramA = Expression.Parameter(typeof(object), "a"),
						paramB = Expression.Parameter(typeof(object), "b");
				...
				_listLessThan.Add(tName, func);
			} else {
				func = _listLessThan[tName];
			}
			return func(a, b);
		}
		...
		public static bool GreaterThanOrEqual(object a, object b, Type aType, Type bType) {
			...
			if(_listGreaterThanOrEqual == null) {
				_listGreaterThanOrEqual = new Dictionary<string, System.Func<object, object, bool>>();
			}
			System.Func<object, object, bool> func;
			string tName = aType.FullName + bType.FullName;
			if(!_listGreaterThanOrEqual.ContainsKey(tName)) {
				try {
					ParameterExpression paramA = Expression.Parameter(typeof(object), "a"),
						paramB = Expression.Parameter(typeof(object), "b");
				...
				_listGreaterThanOrEqual.Add(tName, func);
			} else {
				func = _listGreaterThanOrEqual[tName];
			}
			return func(a, b);
		}
		...
		public static bool LessThanOrEqual(object a, object b, Type aType, Type bType) {
			...
			if(_listLessThanOrEqual == null) {
				_listLessThanOrEqual = new Dictionary<string, System.Func<object, object, bool>>();
			}
			System.Func<object, object, bool> func;
			string tName = aType.FullName + bType.FullName;
			if(!_listLessThanOrEqual.ContainsKey(tName)) {
				try {
					ParameterExpression paramA = Expression.Parameter(typeof(object), "a"),
						paramB = Expression.Parameter(typeof(object), "b");
				...
				_listLessThanOrEqual.Add(tName, func);
			} else {
				func = _listLessThanOrEqual[tName];
			}
			return func(a, b);
		}
		#endregion
		...
		static Dictionary<Type, System.Func<object, object>> convert;

		public static object Convert(object a, Type type) {
			if(convert == null) {
				convert = new Dictionary<Type, Func<object, object>>();
			}
			System.Func<object, object> func;
			if(!convert.TryGetValue(type, out func)) {
