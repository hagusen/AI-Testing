...
namespace MaxyGames.uNode {
	...
	#region WIP
	public class RuntimeArrayType : RuntimeType {
		public readonly Type type;
		readonly Type arrayType = typeof(object[]);

		public override Type BaseType => arrayType.BaseType;
		public override string Name => type.Name + "[]";

		RuntimeArrayType(Type type) {
			this.type = type;
		}

		public RuntimeArrayType Create(Type type) {
			return new RuntimeArrayType(type);
		}
		...
		public override FieldInfo GetField(string name, BindingFlags bindingAttr) {
			return arrayType.GetField(name, bindingAttr);
		}
	...
	public abstract class RuntimeType : Type, IRuntimeMember {
		...
		public MemberInfo[] GetRuntimeMembers() {
