...
namespace MaxyGames.uNode {
	...
	public class GraphData {
		...
		public int lastCompiled;
		public bool isGeneratedWithDebugMode;
		//Generator Settings
		...
		public bool isUpToDate => lastCompiled != 0 && lastSaved == lastCompiled;
	}
	...
	public abstract class uNodeRoot : uNodeComponentSystem, IGraphSystem, IRefreshable, ISummary {
		...
		/// </summary>
		public virtual string GraphName => !string.IsNullOrEmpty(Name) ? Name.Replace(' ', '_') : "_" + Mathf.Abs(GetHashCode());
		#endregion
