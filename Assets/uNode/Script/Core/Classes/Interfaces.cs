...
namespace MaxyGames.uNode {
	...
	public interface IStateGraph : INodeComponent {
		IList<EventNode> eventNodes { get; }
	...
	public interface IRuntimeClass : IRuntimeFunction, IRuntimeVariable, IRuntimeProperty {
		void SetVariable(string Name, object value, string @operator);
		void SetProperty(string Name, object value, string @operator);
	}
	...
	public interface IGraphWithUnityEvent {
		List<EventCaller> functionCallers { get; set; }
		HashSet<System.Type> availableFunctionCallers { get; set; }

		System.Action onAwake { get; set; }
		System.Action onStart { get; set; }
		System.Action onUpdate { get; set; }
		System.Action onFixedUpdate { get; set; }
		System.Action onLateUpdate { get; set; }
		System.Action<int> onAnimatorIK { get; set; }
		System.Action onAnimatorMove { get; set; }
		System.Action<bool> onApplicationFocus { get; set; }
		System.Action<bool> onApplicationPause { get; set; }
		System.Action onApplicationQuit { get; set; }
		System.Action onBecameInvisible { get; set; }
		System.Action onBecameVisible { get; set; }
		System.Action<Collision> onCollisionEnter { get; set; }
		System.Action<Collision2D> onCollisionEnter2D { get; set; }
		System.Action<Collision> onCollisionExit { get; set; }
		System.Action<Collision2D> onCollisionExit2D { get; set; }
		System.Action<Collision> onCollisionStay { get; set; }
		System.Action<Collision2D> onCollisionStay2D { get; set; }
		System.Action onDestroy { get; set; }
		System.Action onDisable { get; set; }
		System.Action onEnable { get; set; }
		System.Action onGUI { get; set; }
		System.Action onMouseDown { get; set; }
		System.Action onMouseDrag { get; set; }
		System.Action onMouseEnter { get; set; }
		System.Action onMouseExit { get; set; }
		System.Action onMouseOver { get; set; }
		System.Action onMouseUp { get; set; }
		System.Action onMouseUpAsButton { get; set; }
		System.Action onPostRender { get; set; }
		System.Action onPreCull { get; set; }
		System.Action onPreRender { get; set; }
		System.Action onRenderObject { get; set; }
		System.Action onTransformChildrenChanged { get; set; }
		System.Action onTransformParentChanged { get; set; }
		System.Action<Collider> onTriggerEnter { get; set; }
		System.Action<Collider2D> onTriggerEnter2D { get; set; }
		System.Action<Collider> onTriggerExit { get; set; }
		System.Action<Collider2D> onTriggerExit2D { get; set; }
		System.Action<Collider> onTriggerStay { get; set; }
		System.Action<Collider2D> onTriggerStay2D { get; set; }
		System.Action onWillRenderObject { get; set; }
	}
