...
namespace MaxyGames {
	public static partial class CodeGenerator {
        #region Constant
		private const string _eventCode = "_ExecuteEvent";
		...
		private const string _runtimeNamespace = "MaxyGames.Runtime";
		private const string _eventCoroutineClass = "MaxyGames.Runtime.EventCoroutine";
